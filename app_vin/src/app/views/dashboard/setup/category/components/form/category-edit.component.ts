...
@Component({
  ...
  template: `
    <div class="flex flex-col max-w-240 md:min-w-160 max-h-screen -m-6">
      ...
      <!-- Compose form -->
        <form class="flex flex-col flex-auto p-6 sm:p-8 overflow-y-auto" [formGroup]="categorytForm">
            <mat-form-field>
...
export class CategoryEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.category) {
      ...
      this.categorytForm.patchValue(this.category);
    }
  }

  public saveForm(): void {
    if (this.categorytForm.valid) {
      this._matDialog.close(this.categorytForm.value);
    }
  }
